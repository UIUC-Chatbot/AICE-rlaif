...
trainer.model.push_to_hub("LongQ/Mistral_SFT_TFQA", private=True, token="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")
trainer.tokenizer.push_to_hub("LongQ/Mistral_SFT_TFQA", private=True, token="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")
# model = AutoModelForCausalLM.from_pretrained("Mistral_SFT_100")
# model.push_to_hub("LongQ/Mistral_SFT_100", private=True, token="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")